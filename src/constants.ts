...
export const Company_Props = [
    //Usuarios
    { id: 14, iconImage: require('./assets/images/icons/suelos.png'), text: 'Suelos', screen: ScreenProps.MenuFloor.screenName },
    { id: 9, iconImage: require('./assets/images/icons/cultivos.png'), text: 'Cultivos', screen: ScreenProps.AdminCrops.screenName },
    { id: 15, iconImage: require('./assets/images/icons/hidrico.png'), text: 'Hídrico', screen: ScreenProps.HidricMenu.screenName },
    { id: 16, iconImage: require('./assets/images/icons/clima.png'), text: 'Clima', screen: ScreenProps.AdminWeather.screenName },
    { id: 17, iconImage: require('./assets/images/icons/plagas.png'), text: 'Plagas', screen: ScreenProps.MenuPests.screenName },
    //{ id: 6, iconImage: require('./assets/images/icons/administracion.png'), text: 'Administración', screen: '' },
    { id: 18, iconImage: require('./assets/images/icons/agricultura-precision.png'), text: 'Agricultura de precisión', screen: ScreenProps.MenuPrecisionAgriculture.screenName  },
   ...
   // { id: 10, iconImage: require('./assets/images/icons/calidad.png'), text: ' Control de calidad', screen: '' },
    ...
    //Administrador
    //REvisar esto
    { id: 99, iconImage: require('./assets/images/icons/lista-usuarios-habilitados.png'), text: 'Lista usuarios habilitados', screen: ScreenProps.AdminUserList.screenName, datoValidacion: '0' },
    ...
    { id: 6, iconImage: require('./assets/images/icons/editar-usuario.png'), text: 'Panel de usuarios', screen: ScreenProps.AdminUserList.screenName, datoValidacion: '1' },
    { id: 7, iconImage: require('./assets/images/icons/campo.png'), text: 'Lista de fincas', screen: ScreenProps.ListEstate.screenName, datoValidacion: '1' },
    { id: 8, iconImage: require('./assets/images/icons/parcela.png'), text: 'Lista de parcelas', screen: ScreenProps.ListPlot.screenName, datoValidacion: '1' },
    { id: 9, iconImage: require('./assets/images/icons/cultivo.png'), text: 'Cultivos', screen: ScreenProps.CropsList.screenName },
    { id: 11, iconImage: require('./assets/images/icons/sensores.png'), text: 'Sensores', screen: ScreenProps.AdminSensors.screenName, datoValidacion: '1' },
    { id: 12, iconImage: require('./assets/images/icons/administracion.png'), text: 'Administración', screen: ScreenProps.AdminAdminstration.screenName },
    { id: 13, iconImage: require('./assets/images/icons/reporte.png'), text: 'Reportes', screen: ScreenProps.AdminReports.screenName, datoValidacion: '1' },
    ...
    //SuperAdmin
    { id: 2, iconImage: require('./assets/images/icons/lista-companias.png'), text: 'Panel de empresas', screen: ScreenProps.CompanyList.screenName },
    { id: 3, iconImage: require('./assets/images/icons/panel-usuarios-administradores.png'), text: 'Panel usuarios administradores', screen: ScreenProps.AdminUserList.screenName, datoValidacion: '0' },
    { id: 4, iconImage: require('./assets/images/icons/grafico-de-barras.png'), text: 'Mediciones de sensor', screen: ScreenProps.ListMeasureSensor.screenName, datoValidacion: '0' },
    { id: 5, iconImage: require('./assets/images/icons/medida-cultivo.png'), text: 'Mediciones de cultivos', screen: ScreenProps.CropMeasurementsList.screenName, datoValidacion: '0' },
    { id: 10, iconImage: require('./assets/images/icons/historial.png'), text: 'Catálogo de actividades de preparación de terreno', screen: ScreenProps.ListCatalogoActividades.screenName, datoValidacion: '0 ' },
]

export const Admin_cultivation = [
    { id: 10, iconImage: require('./assets/images/icons/rotacion-cultivos.png'), text: 'Rotación de cultivos según estacionalidad', screen: ScreenProps.CropRotationList.screenName },
    { id: 13, iconImage: require('./assets/images/icons/productividad.png'), text: 'Productividad de cultivo', screen: ScreenProps.ListProductivity.screenName },
    { id: 12, iconImage: require('./assets/images/icons/montana.png'), text: 'Preparación del terreno y prácticas de conservación', screen: ScreenProps.ListLandPreparation.screenName },
    { id: 11, iconImage: require('./assets/images/icons/historial.png'), text: 'Historial de manejo  de residuos de la finca', screen: ScreenProps.ResidueList.screenName },
//falta cultivos id 9
]

export const Admin_suelo = [
    { id: 28, iconImage: require('./assets/images/icons/fertilizante.png'), text: 'Manejo de fertilizantes', screen: ScreenProps.ListFertilizer.screenName },
    { id: 30, iconImage: require('./assets/images/icons/suelo.png'), text: 'Calidad de suelo', screen: ScreenProps.ListQualityFloorScreen.screenName },
    { id: 29, iconImage: require('./assets/images/icons/analisis.png'), text: 'Tipo de aplicación', screen: ScreenProps.ListApplicationType.screenName },
]


export const Admin_hidrico = [
    { id: 31, iconImage: require('./assets/images/icons/fertilizante.png'), text: 'Seguimiento del agua', screen: ScreenProps.WatchListWaterScreen.screenName },
    { id: 32, iconImage: require('./assets/images/icons/eficiencia-riego.png'), text: 'Monitoreo de la eficiencia de riego', screen: ScreenProps.ListIrrigationEfficiency.screenName },
    { id: 33, iconImage: require('./assets/images/icons/estres-hidrico.png'), text: 'Estrés hídrico', screen: ScreenProps.ListSoilElectricalConductivity.screenName },
...
export const Admin_clima = [
    { id: 34, iconImage: require('./assets/images/icons/weather.png'), text: 'Pronóstico meteorológico', screen: ScreenProps.WatchWeather.screenName },
    { id: 35, iconImage: require('./assets/images/icons/condiciones-climaticas.png'), text: 'Condiciones meteorológicas y climáticas', screen: ScreenProps.ListWeatherClimateConditions.screenName },
    { id: 36, iconImage: require('./assets/images/icons/calentamiento-global.png'), text: 'Riesgos naturales', screen: ScreenProps.RiskNaturalList.screenName },
]

export const Admin_Agricultura_Precision = [
    { id: 40, iconImage: require('./assets/images/icons/salud-planta.png'), text: 'Salud de la planta', screen: ScreenProps.PlantHealthList.screenName },
    { id: 38, iconImage: require('./assets/images/icons/clorofila.png'), text: 'Contenido clorofila', screen: ScreenProps.ChlorophyllContentList.screenName },
    { id: 41, iconImage: require('./assets/images/icons/cantidad-plantas.png'), text: 'Cantidad de plantas', screen: ScreenProps.NumberOfPlantsList.screenName },
    { id: 42, iconImage: require('./assets/images/icons/contenidodeagua.png'), text: 'Contenido de agua', screen: ScreenProps.WaterContentList.screenName },
    { id: 43, iconImage: require('./assets/images/icons/cobertura-vegetal.png'), text: 'Cobertura vegetal', screen: ScreenProps.VegetationcoverList.screenName },
    { id: 39, iconImage: require('./assets/images/icons/nitrogen.png'), text: 'Contenido nitrógeno', screen: ScreenProps.NitrogenContentList.screenName },
...
export const Admin_plagas = [
    { id: 37, iconImage: require('./assets/images/icons/plagas&enfermedades.png'), text: 'Problemas asociados a plagas y enfermedades', screen: ScreenProps.ListPestsDiseases.screenName },
]

export const Admin_sensor = [
    { id: 15, iconImage: require('./assets/images/icons/sensor.png'), text: 'Sensores', screen: ScreenProps.ListSensors.screenName },
    { id: 16, iconImage: require('./assets/images/icons/punto-medicion.png'), text: 'Punto medición', screen: ScreenProps.ListMeasurementPoint.screenName },
]

export const Admin_ordenCompra = [
    { id: 17, iconImage: require('./assets/images/icons/ordenCompra.png'), text: 'Orden de compra', screen: ScreenProps.ListPurchaseOrder.screenName },
    { id: 18, iconImage: require('./assets/images/icons/arriba-y-abajo.png'), text: 'Entradas y salidas', screen: ScreenProps.ListInflowsOutflows.screenName },
    { id: 19, iconImage: require('./assets/images/icons/mano-obra.png'), text: 'Mano de obra', screen: ScreenProps.ListManoObra.screenName},
]


export const Admin_Reports = [
    { id: 20, iconImage: require('./assets/images/icons/arriba-y-abajo.png'), text: 'Reporte entrada salida total', screen: ScreenProps.ReportEntradaSalidaTotal.screenName },
    { id: 21, iconImage: require('./assets/images/icons/entrada.png'), text: 'Reporte entrada total', screen: ScreenProps.ReportEntradaTotal.screenName },
    { id: 22, iconImage: require('./assets/images/icons/salida.png'), text: 'Reporte salida total', screen: ScreenProps.ReportSalidaTotal.screenName },
    { id: 23, iconImage: require('./assets/images/icons/orden-compra.png'), text: 'Reporte orden de compra', screen: ScreenProps.ReportOrdenDeCompra.screenName },
    { id: 24, iconImage: require('./assets/images/icons/mano-obra.png'), text: 'Reporte planilla', screen: ScreenProps.ReportPlanilla.screenName },
]

// const { userData  } = useAuth();
// export const obtener=()=>{
//     const prueba=ObtenerAccesoMenuPorRol(userData.idRol);
//     console.log('Constants', prueba);
// }
// obtener();