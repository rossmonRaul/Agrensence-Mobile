...
export const ObtenerUsuariosPorRol2 = async () => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/ObtenerUsuariosPorRol2`;
    return await ProcesarDatosApi('GET', url, '');
}
...
export const GuardarUsuario = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/GuardarUsuario`;
    return await ProcesarDatosApi('POST', url, data);
}
...
export const ObtenerUsuariosPorRol3 = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/ObtenerUsuariosPorRol3`;
    return await ProcesarDatosApi('POST', url, data);
}
export const ObtenerUsuariosPorIdEmpresa = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/ObtenerUsuariosPorIdEmpresa`;
    return await ProcesarDatosApi('POST', url, data);
}
...
export const ActualizarContrasenaUsuario = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/ActualizarContrasenaUsuario`;
    return await ProcesarDatosApi('PUT', url, data);
}
export const ActualizarUsuarioAdministrador = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/ActualizarUsuarioAdministrador`;
    return await ProcesarDatosApi('PUT', url, data);
}

export const AsignarFincaParcela = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/AsignarFincaParcela`;
    return await ProcesarDatosApi('PUT', url, data);
}
export const AsignarEmpresaFincaYParcela = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/AsignarEmpresaFincaYParcela`;
    return await ProcesarDatosApi('PUT', url, data);
}

export const AsignarNuevaFincaParcela = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/AsignarNuevaFincaParcela`;
    return await ProcesarDatosApi('PUT', url, data);
}
export const CambiarEstadoUsuarioFincaParcela = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/CambiarEstadoUsuarioFincaParcela`;
    return await ProcesarDatosApi('PUT', url, data);
}

export const CambiarEstadoUsuario = async (data: any) => {
    const url = `http://${IP_API}:5271/api/v1.0/${controlador}/CambiarEstadoUsuario`;
    return await ProcesarDatosApi('PUT', url, data);
}
