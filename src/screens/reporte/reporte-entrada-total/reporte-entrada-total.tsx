...
export const ReporteEntradaTotal:  React.FC = () => {
    ...
    const [entradaTotales, setEntradaTotales] = useState<any[]>([]);  
    ...
    const handleDateFilter = async () => {
        ...
        const entradaSalidaResponse = await ObtenerReporteIngreso(formData);
        ...
        <View style={styles.listcontainer}>
            ...
            <View style={styles.rowContainer} >
                {!entradaTotales ? (
                    ...
                    <>
                        {entradaTotales.map((item, index) => (
                            <CustomRectangle
                                key={item.ingresoTotal}
