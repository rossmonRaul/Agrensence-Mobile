...
export const ReporteEntradaSalidaTotal: React.FC = () => {
    ...
    const [entradaSalidasTotales, setEntradaSalidasTotales] = useState<any[]>([]);
   ...
   // Estados para la paginación
    ...
    const handleDateFilter = async () => {
        ...
        const entradaSalidaResponse = await ObtenerReporteEntradaSalidaTotal(formData);

        setEntradasSalidas(entradaSalidaResponse);
        setEntradasSalidasExportar(entradaSalidaResponse);
        setEntradaSalidasTotales([]);
        let valorIngresoTotal=0;
        let valorGastoTotal=0;
        ...
        <View style={styles.listcontainer}>
            ...
            <View style={styles.rowContainer} >
                {!entradaSalidasTotales ? (
                    ...
                    <>
                        {entradaSalidasTotales.map((item, index) => (
                            <CustomRectangle
                                key={item.balanceTotal}
